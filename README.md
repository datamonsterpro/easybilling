...
1. Перенос кастомеров
2. Перенос подписок
3. Перенос закрывашек
4. Перенос скидок
5. Перенос кредитов
6. Перенос транзакций

### Настройка операций

1. Создать кастомера и сохранить в таблице user сustomer id
2. Создать транзакцию на платеж по карте
3. Создать транзакцию на платеж от юрлица
4. Создать транзакцию на доверенный платеж
5. Передать закрывашку
